...
import { useGetAddressByIdQuery, useUpdateAddressMutation } from './addressApiSlice';

const EditAddress = () => {

 const [updateAddress] = useUpdateAddressMutation();
 const {data: address} = useGetAddressByIdQuery(id);
 ...
 const onSubmit = async (data) =>{
    if(!data) return {};
    await updateAddress({...data, id}).unwrap();
